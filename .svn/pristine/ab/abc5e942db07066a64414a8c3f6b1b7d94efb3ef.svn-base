 ...
 *
c3:定义
  comm0:ttl232 ttys0    pc(232,4850)
  comm1: ct232 ttys1   指纹读头,4851
  comm2; st232 ttys2 控制台，调试用
  comm3: ff232 ttys3 gprs
 *     ......
 */
...
{
	RS485_ChangeStatus(&ttl232, SendMode);
}

/*
void EXT_RS485_setmode(U32 SendMode)
{
	RS485_ChangeStatus(&ct232, SendMode);

	GPIO_EXT_RS485_Status(SendMode);
	if (SendMode)
		ct232->flush_input();  // RS485 Send mode
	else
		ct232->flush_output(); // RS485 Receive mode
	DelayUS(1000);
}
*/
