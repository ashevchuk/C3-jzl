...
#define SDCARD_CHECK		90

//485en: c4 : 104     c3:104  旧版本c3为33
#define  RS485_SEND				104			

//c3 单片机任务状态pin  为低电平，表示单片机有任务事件
#define IO_C4_STATE 		103		//平时是高电平，有事件时是低电平

#define  IO_RED_LED		105			//ZEM500
#define  IO_LOCK		34
#define  IO_ALARM_STRIP		75		//zzz 35
//以下wgd0 wgd1在c3/c4中用作net led驱动用
#ifdef MACHINETYPE_C4
#define  IO_WIEGAND_OUT_D0	100	//ZEM510
#define  IO_WIEGAND_OUT_D1	101	//ZEM510
#else
#define  IO_WIEGAND_OUT_D0	100	//ZEM510
#define  IO_WIEGAND_OUT_D1	101	//ZEM510
#endif
...
void GPIO_netled_Status(U32 status);
